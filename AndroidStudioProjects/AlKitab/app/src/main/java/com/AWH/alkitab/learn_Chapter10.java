...
public class learn_Chapter10 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn__chapter10);
    ...
    public void modifyScreen(){
        ...
        long chaptervalue = prefs.getLong("learnChapterTenQari"+Qari, 1000);
...
//            }
    ...
    public void updateSharedPref(){
        ...
        editor.putLong("learnChapterTenQari"+Qari,chaptervalue+1);
        editor.apply();

        updateOnServer(prefs.getLong("learnChapterTenQari"+Qari, 1000));
    ...
    public void updateOnServer(long chaptervalue){
        ...
        db.collection("users").document(userID)
                .update("learnChapterTenQari"+Qari, chaptervalue)
