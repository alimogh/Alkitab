...
public class learn_Chapter12 extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn__chapter12);
    ...
    public void modifyScreen(){
        ...
        long chaptervalue = prefs.getLong("learnChapterTwelveQari"+Qari, 1000);
...
//            }
    ...
    public void updateSharedPref(){
        ...
        editor.putLong("learnChapterTwelveQari"+Qari,chaptervalue+1);
        editor.apply();

        updateOnServer(prefs.getLong("learnChapterTwelveQari"+Qari, 1000));
    ...
    public void updateOnServer(long chaptervalue){
        ...
        db.collection("users").document(userID)
                .update("learnChapterTwelveQari"+Qari, chaptervalue)
