...
public class DateHigri {
    ...
    public static double gmod(double n,double  m) {
        return ((n % m) + m) % m;
    }
    ...
    static double[] kuwaiticalendar1(boolean adjust, int year_, int month_, int day_) {
        int day1= day_;
        int month1= month_;
        int year1= year_;
        Calendar today = Calendar.getInstance();
        ...
        double  month = Double.parseDouble(month1+"");
        double  year = Double.parseDouble(year1+"");
    ...
    static String writeIslamicDate() {
        String[] wdNames = {"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday",
                "Jumuah", "Saturday"};
        String[] iMonthNames = {"Muharram", "Safar", "Rabi'ul Awwal",
                "Rabi'ul Sani", "Jumadi ul Awal", "Jumadi ul Sani", "Rajab",
                "Shaban", "Ramazan", "Shawwal", "ZilQad", "ZilHaj"};
    ...
    static String writeIslamicDate1(int year_, int month_, int day_) {
        String[] wdNames = {"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday",
                "Jumuah", "Saturday"};
        String[] iMonthNames = {"Muharram", "Safar", "Rabi'ul Awwal",
                "Rabi'ul Sani", "Jumadi ul Awal", "Jumadi ul Sani", "Rajab",
        ...
        // This Value is used to give the correct day +- 1 day
        boolean dayTest=true;
        double[] iDate = kuwaiticalendar1(dayTest,year_,month_,day_);
        String outputIslamicDate = wdNames[(int) iDate[4]] + ", " + iDate[5] + " "
                + iMonthNames[(int) iDate[6]] + " " + iDate[7] + " AH";
