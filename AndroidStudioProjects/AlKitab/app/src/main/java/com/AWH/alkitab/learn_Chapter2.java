...
public class learn_Chapter2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn__chapter2);
    ...
    public void modifyScreen(){
        ...
        long chaptervalue = prefs.getLong("learnChapterTwoQari"+Qari, 1000);
    ...
    public void updateSharedPref(){
        ...
        editor.putLong("learnChapterTwoQari"+Qari,chaptervalue+1);
        editor.apply();

        updateOnServer(prefs.getLong("learnChapterTwoQari"+Qari, 1000));
    ...
    public void updateOnServer(long chaptervalue){
        ...
        db.collection("users").document(userID)
                .update("learnChapterTwoQari"+Qari, chaptervalue)
