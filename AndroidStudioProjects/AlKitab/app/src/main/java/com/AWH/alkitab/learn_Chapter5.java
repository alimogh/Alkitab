...
public class learn_Chapter5 extends AppCompatActivity implements View.OnClickListener  {

    MediaPlayer mp;


    Integer [] audioQ1 = {R.raw.e1_q1,R.raw.e2_q1,R.raw.e3_q1,R.raw.e4_q1,R.raw.e5_q1,R.raw.e6_q1,R.raw.e7_q1,R.raw.e8_q1,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn__chapter5);
    ...
    public void modifyScreen(){
        ...
        long chaptervalue = prefs.getLong("learnChapterFiveQari"+Qari, 1000);
    ...
    public void updateSharedPref(){
        ...
        editor.putLong("learnChapterFiveQari"+Qari,chaptervalue+1);
        editor.apply();

        updateOnServer(prefs.getLong("learnChapterFiveQari"+Qari, 1000));
    ...
    public void updateOnServer(long chaptervalue){
        ...
        db.collection("users").document(userID)
                .update("learnChapterFiveQari"+Qari, chaptervalue)
